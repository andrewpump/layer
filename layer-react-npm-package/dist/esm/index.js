...
var ItemDetail = forwardRef(function (_a, ref) {
    ...
    return (React__default.createElement("div", { ref: refForDiv, style: { backgroundColor: "".concat(color, "18") }, className: "ai-assistant-item-details-main-container" },
        React__default.createElement("div", { className: "ai-assistant-item-details-container" },
            ...
            React__default.createElement(Text, { className: "detail-text-style", label: item.content }))));
});
...
var AiAssistant = function (_a) {
    ...
    var _g = useState(false), showDiv = _g[0], setShowDiv = _g[1];
    var springProps = J({
    ...
    return (React__default.createElement(React__default.Fragment, null,
        React__default.createElement("div", { className: "ai-assistant-main-container" },
            React__default.createElement(Button, { style: { backgroundColor: color }, className: "main-popup-button", onClick: function () { return onClickPopupButton(); }, child: showPopUp ? (React__default.createElement(CrossIcon, { color: "#ffffff" })) : (React__default.createElement("img", { src: image, alt: "img", width: "32px", height: "32px" })) }),
            showPopUp && (React__default.createElement(it.div, { style: springProps, ref: refPopUp, id: "tunnel", className: "main-popup-container-animate-start" },
                ...
                React__default.createElement("div", { className: "popup-header-container", style: { borderBottomColor: color } },
                    showDetails && (React__default.createElement("button", { ref: refBackButton, onClick: function () { return onClickBackButton(); }, className: "header-back-button-style" },
                        React__default.createElement(ArrowRightIcon, { color: color }))),
                    React__default.createElement("div", { className: "header-text-container" },
                        React__default.createElement(Text, { className: "header-text-style", label: "Bops Insight" }))),
                React__default.createElement("div", { className: "main-item-list-container" }, showDetails ? (React__default.createElement(ItemDetail, { id: "detailif", ref: ref, color: color, itemData: itemDataList[selectedItem] })) : (itemList.map(function (item, index) { return (React__default.createElement(ListItem, { item: item, key: index, onClickList: function () {
