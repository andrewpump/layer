...
var AiAssistant = function (_a) {
    ...
    return (React__default["default"].createElement("div", { className: "ai-assistant-main-container" },
        ...
        showPopUp && (React__default["default"].createElement("div", { ref: refPopUp, id: "tunnel", className: "main-popup-container-animate-start" },
            ...
            React__default["default"].createElement("div", { className: "main-item-list-container" }, showDetails ? (React__default["default"].createElement(ItemDetail, { id: "detailif", ref: ref, color: color, itemData: itemDataList[selectedItem] })) : (itemList.map(function (item, index) { return (React__default["default"].createElement(ListItem, { item: item, key: index, onClickList: function () { onClickList(item.title); setSelectedItem(index); }, color: color })); })))))));
};
