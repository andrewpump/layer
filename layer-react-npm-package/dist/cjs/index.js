    ...
    return (React__default["default"].createElement("div", { ref: refForDiv, style: { backgroundColor: "".concat(color, "18") }, className: "ai-assistant-item-details-main-container" },
        React__default["default"].createElement("div", { className: "ai-assistant-item-details-container" },
            React__default["default"].createElement("div", { style: { borderBottomColor: color }, className: "ai-assistant-item-details-heading-text-container " },
                React__default["default"].createElement(Text, { className: "title-text-style", label: "Purchase More:" }),
                React__default["default"].createElement(Text, { className: "subtitle-text-style", label: "PRINGLES SOUR CREAM & ONION PO" })),
            React__default["default"].createElement(Text, { className: "detail-text-style", label: 'The policy action recommended for the product "PRINGLES SOUR CREAM & ONION PO" is to "Purchase more product" due to low inventory levels. The target inventory for the product is 4,982, but the current inventory available is only 4 units which is significantly low. The available weekly inventory on hand is estimated to be 4,929.6 units, with a monthly demand estimated to be 1,190 units. In the last 4 weeks, the product has had a demand of 5,057 units, an amount which is greater than the available inventory. Furthermore, based on the ABC classification, this product is classified as "A", which means high consumption and therefore requires adequate stocking.Based on this information, purchasing more product should be done to prevent understocking and ensure that the available inventory meets demand.' }))));
});
...
var AiAssistant = function (_a) {
    ...
    return (React__default["default"].createElement("div", { className: "ai-assistant-main-container" },
        ...
        showPopUp && (React__default["default"].createElement("div", { ref: refPopUp, id: "tunnel", className: "main-popup-container-animate-start" },
