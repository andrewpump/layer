...
var ArrowForwardIcon = function (_a) {
    ...
    return (React__default["default"].createElement("svg", __assign({ width: "9", height: "14", viewBox: "0 0 9 14", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, props),
        React__default["default"].createElement("path", { d: "M1.35008 13.6667L0.166748 12.4833L5.65008 6.99999L0.166748 1.51666L1.35008 0.333328L8.01675 6.99999L1.35008 13.6667Z", fill: color === "#000000" ? "#000000" : color })));
};

var ListItem = function (_a) {
    var item = _a.item, onClickList = _a.onClickList, color = _a.color;
    return (React__default["default"].createElement(Button, { onClick: onClickList, style: { backgroundColor: "".concat(color, "18") }, className: "ai-assistant-list-item-main-container", child: React__default["default"].createElement("div", { className: "container" },
            React__default["default"].createElement("div", { className: "text-container" },
                React__default["default"].createElement(Text, { className: "title-text-style", label: item.title }),
                React__default["default"].createElement(Text, { className: "subtitle-text-style", label: item.subtitle })),
...
var CrossIcon = function (_a) {
    var _b = _a.color, color = _b === void 0 ? "#000000" : _b, props = __rest(_a, ["color"]);
    return (React__default["default"].createElement("svg", __assign({ width: "28", height: "28", viewBox: "0 0 28 28", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, props),
        React__default["default"].createElement("path", { d: "M2.8 28L0 25.2L11.2 14L0 2.8L2.8 0L14 11.2L25.2 0L28 2.8L16.8 14L28 25.2L25.2 28L14 16.8L2.8 28Z", fill: color === "#000000" ? "#000000" : color })));
};
...
var MyDataListEngine = /** @class */ (function () {
    function MyDataListEngine() {
        ...
        this.chatBotResponse = function (searchItemData) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, axios__default["default"].get("http://localhost:5000?query=".concat(searchItemData))];
                    case 1:
                        res = _a.sent();
                        return [2 /*return*/, res];
                }
...
var AiAssistant = function (_a) {
    ...
    var _c = React.useState(false), showWidget = _c[0], setShowWidget = _c[1];
    var _d = React.useState(false), showDetails = _d[0], setShowDetails = _d[1];
    var _e = React.useState(false), showEnvError = _e[0]; _e[1];
    var _f = React.useState(false), showStatusError = _f[0], setShowStatusError = _f[1];
    var _g = React.useState(false), updateItemdata = _g[0], setUpdateItemData = _g[1];
    var _h = React.useState([]), itemDataList = _h[0], setItemDataList = _h[1];
    var _j = React.useState(0), selectedItem = _j[0], setSelectedItem = _j[1];
    var _k = React.useState(false), showDiv = _k[0], setShowDiv = _k[1];
    var _l = React.useState(false), showArrowButton = _l[0], setShowArrowButton = _l[1];
    var _m = React.useState(0), divHeight = _m[0], setDivHeight = _m[1];
    var _o = React.useState({}), insightData = _o[0], setInsightData = _o[1];
    // Refs
